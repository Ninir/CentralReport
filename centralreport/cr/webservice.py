    ...
    def send_full_check():
        ...
        if cr.threads.Checks.last_check_date is None:
            ...
            if cr.threads.Checks.last_check_cpu is None:
                ...
                tmpl_vars['cpu_percent'] = int(cr.threads.Checks.last_check_cpu.user) + int(cr.threads.Checks.last_check_cpu.system)
            ...
            if cr.threads.Checks.last_check_loadAverage is None:
                ...
                tmpl_vars['uptime_seconds'] = text.add_number_separators(str(cr.threads.Checks.last_check_loadAverage.uptime))
